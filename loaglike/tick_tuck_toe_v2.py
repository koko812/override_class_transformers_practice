...
# なーんでこんなに設計が苦手なのかねえ．．どうも苦手なんだよねえほんと
# やっぱりパターンを持ってないのがしんどいのだろうか？？
# ちょっと気分転換にシューティングでも作ってみるか？
# シューティング or 五目並べ or グリッドでいこうか

# やってみて思うが，まじでこのコードで動いてんの奇跡すぎて笑っちゃうね
# どこまでゴミなコードでゲームを作れるか試してみたいかもしれん

# 一定時間で強制終了するようになってるんだが，これは体験版バージョンのゲームに似てる気がして
# まあアレは，もう一段上のやつが終了させに行ってるんだとは思うが．
# そういう，プログラムの階層みたいなやつ？を自分で作れるようになりたい感じはあるかもな
# まあ，ゲーム投稿サイトみたいなのを作ったら，勝手にそういうことはやるようになるんじゃないかと思うけど，
# ただ，そういうサイトはあまりにも運用が難しそうすぎて困るんだよなあ，やってみないことには始まらないんだけど

# いや，まじでよくできてて我ながら感動しちゃうねこれは